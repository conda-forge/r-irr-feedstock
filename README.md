...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-irr-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-irr-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-irr-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-irr-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-irr-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-irr-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `r-irr` can be installed with:

```
conda install r-irr
```

It is possible to list all of the versions of `r-irr` available on your platform with:
